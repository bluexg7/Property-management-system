...
<div id=win style="display: none; position: absolute; left: 50%; top: 40%; width: 450px; height: 340px; margin-left: -300px; margin-top: -200px; border: 1px solid #888; background-color: #ffffff; text-align: center;">
     ...
     <table style="background-color:#008080;" width="100%" heigh="20%">
     	<tr>
     		<td width="90%"><span><font color="#f5f5f5" face="microsoft yahei" size="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;部门信息</font></span></td>
     		<td width="10%"><a href="javascript:closeLogin();" align="right" ; class="close">关闭</a></td>
     	</tr>
     </table>
     <br>
     <span style="position: absolute; left: 21%;">部&nbsp;门&nbsp;编&nbsp;号:</span><input id="showdepart_num" style="width:160px; height:15px; background-color:#ffffff; border:solid 1px #7dbad7; font-size:12px; color:#000000;position: absolute; left: 42%;" disabled></input>  <br><br>
     <span style="position: absolute; left: 21%;">部&nbsp;门&nbsp;名&nbsp;称:</span><input id="showdepart_name" style="width:160px; height:15px; background-color:#ffffff; border:solid 1px #7dbad7; font-size:12px; color:#000000;position: absolute; left: 42%;" ></input> <br><br>
     <span style="position: absolute; left: 21%;">办&nbsp;公&nbsp;室&nbsp;号:</span><input id="showoffice_num" style="width:160px; height:15px; background-color:#ffffff; border:solid 1px #7dbad7; font-size:12px; color:#000000;position: absolute; left: 42%;" onkeyup="IsInteger(2,this)"></input><span id="error2" style="color:red;font-size:9px;position: absolute; left: 80%;"></span><br><br>   
     <span style="position: absolute; left: 21%;">员&nbsp;工&nbsp;总&nbsp;数:</span><input id="showstaff_num" style="width:160px; height:15px; background-color:#ffffff; border:solid 1px #7dbad7; font-size:12px; color:#000000 ;position: absolute; left: 42%;" onkeyup="IsInteger(3,this)"></input><span id="error3" style="color:red; font-size:9px;position: absolute; left: 80%;" ></span><br> <br>
     <span style="position: absolute; left: 21%;">经&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;理:</span><input id="showmanager" style="width:160px; height:15px; background-color:#ffffff; border:solid 1px #7dbad7; font-size:12px; color:#000000;position: absolute; left: 42%;" onkeyup="IsChinese(4,this)"><span id="error4" style="color:red;font-size:9px;position: absolute; left: 80%;"></span><br><br>
     <span style="position: absolute; left: 21%;">规&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;则:</span><input id="showrule" style="width:160px; height:15px; background-color:#ffffff; border:solid 1px #7dbad7; font-size:12px; color:#000000;position: absolute; left: 42%;" ></input><br>
...
<div id=addwin style="display: none; position: absolute; left: 50%; top: 40%; width: 420px; height: 340px; margin-left: -300px; margin-top: -200px; 
		...
		<table style="background-color:#008080;" width="100%" heigh="20%">
			<tr>
				<td width="90%"><label><font color="#f5f5f5" face="microsoft yahei" size="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;添加部门信息</font></label></td>
...
function delSingleItem(delId){ 
    ...
    if(isSureDeled){
	    ...
	    doc.getElementsByName("delSolve")[0].value=departKey+'#';//获取房间key值    	   
	    for (i=1;i<departInfoTable.rows.length;i++){//排序
...
{     	
        ...
        reg=/^[\u0391-\uFFE5]+$/;    
        if(!reg.test(str)){
        document.getElementById("error"+i).innerHTML='*请输入中文';       
        }
         else document.getElementById("error"+i).innerHTML='' ;    
        }    
}
