...
function jumpTo(){
	 ...
	 if(temp<=count&&temp>0)
	  	window.location.href="../servlet/Clean1?jump_type=jump_to&to_page="+temp;
}
function closeLogin(){   
...
function addSured(){  
	 ...
	 if(isSureAdded==true){
	     ...
	     addForm.action="../servlet/Clean1_Insert";
	     addForm.submit(); 
	     closeAdd();    
	 }
	 else
...
function editSured(){ 
    ...
    if(isSureEdited==true)
    {
	   ...
	   form.action="../servlet/Clean1_Update";
	   form.submit();
	   closeLogin();
   }
   else
...
function delSingleItem(delId){ 
    ...
    if(isSureDeled){
	   ...
	   // }  //for
	    ...
	    f.action="../servlet/Clean1_Delete";
	    f.submit();   
    }//if         
}
//批量删除函数 2015.7.13
function delBatItems(){ 
   ...
   keyform.action="../servlet/Clean1_Delete";
   keyform.submit();  
}
//弹出添加窗口 2015.7.14
function addItem(){
...
<div class="box1">&nbsp;
	...
	<font color="blue" size=2pt>[保洁管理]-[保洁信息管理]<br ></br> </font>
</div>
<br>
 <form action="../servlet/Clean1_Select" method="post" name="queryform">
			<table class="gridtable" width="98%" border="0" cellspacing="0"
					cellpadding="0">
					<tr>
						<td>
							<font size=2>&nbsp;&nbsp;保洁员编号:</font>
							<input type="text" id="cleaner_num" name="cleaner_num"></input>
						</td>
						<td>
							<font size=2>&nbsp;&nbsp;保洁员姓名:</font>
										...
										<tr>
											...
											<td>
												<table border="0" align="right" cellpadding="0" cellspacing="0">					  
													<tr>
														<td width="40">										
														    <div align="center"><a href="../servlet/Clean1?jump_type=first"><img src="<%=basePath%>/images/first.gif" width="37" height="15"/></a></div></td>
														</td>
														...
														<td width="45">													    
														    ...
														    <%
														        if(((Integer)session.getAttribute("currentPage")).intValue()>=2){												    	   
														    	    out.print("<a href=\"../servlet/Clean1?jump_type=back\">");
														    	}												    
														    %>														  
														...
														<td width="45">
														    <div align="center">
														     ...
														     if(((Integer)session.getAttribute("currentPage")).intValue()<((Integer)session.getAttribute("pageCount")/15+((Integer)session.getAttribute("pageCount")%15!=0?1:0))){							    	    
														    	 out.print("<a href=\"../servlet/Clean1?jump_type=next\">");
														     }									  											    
														    %>													  													   	
															<img src="<%=basePath%>/images/next.gif" width="43" height="15" /></a></div>								
														</td>
																					
														<td width="40"><div align="center"><a href="../servlet/Clean1?jump_type=last"><img src="<%=basePath%>/images/last.gif" width="37" height="15" /></a></div>																							
														</td>
