...
<div id=win style="display: none; position: absolute; left: 50%; top: 40%; width: 370px; height: 320px; margin-left: -300px; margin-top: -200px; border: 1px solid #888; background-color: gray; text-align: center;">
     ...
     <span>&nbsp;&nbsp;保安编号:</span><input id="showcleaner_num"></input><br><br>   
...
function jumpTo(){
	 ...
	 if(temp<=count&&temp>0)
	  	window.location.href="../servlet/Security3?jump_type=jump_to&to_page="+temp;
}
function closeLogin(){   
...
function submit(){
 	var form=doc.forms("transform");  //对应第一个table form
   	form.action="../servlet/Security3_Update";
    form.submit();
}
...
function addSured(){  
	 ...
	 if(isSureAdded==true){
	    ...
	    addForm.action="../servlet/Security3_Insert";
	    addForm.submit(); 
	    closeAdd();    
	 }
	 else
...
function delSingleItem(delId){ 
    ...
    if(isSureDeled){
	    ...
	    form.action="../servlet/Security3_Delete";
	    form.submit();   
    }//if         
}
function resetAll(){
...
function delBatItems(){ 
   ...
   keyform.action="../servlet/Security3_Delete";
   keyform.submit();  
}
</script>
...
<div class="box1">&nbsp;
	...
	<font color="blue" size=2pt>[保安管理]-[工作检查统计]<br ></br> </font>
</div>
<br>
 <form action="../servlet/Security3_Select" method="post" name="queryform">
										...
										<tr>
											...
											<td>
												<table border="0" align="right" cellpadding="0" cellspacing="0">					  
													<tr>
														<td width="40">										
														    <div align="center"><a href="../servlet/Security3?jump_type=first"><img src="<%=basePath%>/images/first.gif" width="37" height="15"/></a></div></td>
														</td>
														...
														<td width="45">													    
														    ...
														    <%
														        if(((Integer)session.getAttribute("currentPage")).intValue()>=2){												    	   
														    	    out.print("<a href=\"../servlet/Security3?jump_type=back\">");
														    	}												    
														    %>														  
														...
														<td width="45">
														    <div align="center">
														     ...
														     if(((Integer)session.getAttribute("currentPage")).intValue()<((Integer)session.getAttribute("pageCount")/15+((Integer)session.getAttribute("pageCount")%15!=0?1:0))){							    	    
														    	 out.print("<a href=\"../servlet/Security3?jump_type=next\">");
														     }									  											    
														    %>													  													   	
															<img src="<%=basePath%>/images/next.gif" width="43" height="15" /></a></div>								
														</td>
																					
														<td width="40"><div align="center"><a href="../servlet/Security3?jump_type=last"><img src="<%=basePath%>/images/last.gif" width="37" height="15" /></a></div>																							
														</td>
