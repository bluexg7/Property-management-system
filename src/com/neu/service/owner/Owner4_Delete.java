...
public class Owner4_Delete extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		for(String r:examInfo){
			String str[] = r.split("-");
			Owner4.Owner4Delete(str[0]);
		}

		
		request.getRequestDispatcher("../servlet/Owner4?jump_type=first").forward(request,response);
