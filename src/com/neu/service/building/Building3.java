...
public class Building3 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Building3_Info> resultList = b3_dao.select(com_name,build_num,unit_num,room_num,owner_name,start_time,end_time);
		...
		request.getRequestDispatcher("../building/building3.jsp").forward(request,
				response);
